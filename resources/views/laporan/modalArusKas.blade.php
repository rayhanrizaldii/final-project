<div class="modal fade text-left" id="defaultArusKas" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2"
    aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
                {{-- @if (isset($transaksi[0]) && isset($transaksi[0]->coa))
                    ...
                    @endif --}}
                <h5 class="modal-title" id="myModalLabel3">Detail Arus</h5>
