...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('template/assets/compiled/css/error.css') }}">
</head>
        ...
        <div class="error-page container">
            <div class="col-md-8 col-12 offset-md-2">
                <div class="text-center">
                    <img class="img-error" src="{{ asset('template/assets/compiled/svg/error-403.svg') }}"
                        alt="Not Found">
